                  ...
                  {leftBreakers.length > 0 ? (
                    (() => {
                      ...
                      if (hasTandem && baseBreaker) {
                        ...
                        // Derive status and power from children (OR logic)
                        const isAnyChildActive = tandemBreakers.some(b => b.status === 'active')
                        const isAnyChildPowered = tandemBreakers.some(b => b.is_powered)
                        const derivedIsSpare = !isAnyChildActive
                        const derivedIsPoweredOff = !isAnyChildPowered
                            ...
                            >
                              <div className="flex items-center justify-between gap-2">
                                ...
                                <div className="flex items-center gap-2">
                                  {/* Status indicator */}
                                  {derivedIsSpare || derivedIsPoweredOff ? (
